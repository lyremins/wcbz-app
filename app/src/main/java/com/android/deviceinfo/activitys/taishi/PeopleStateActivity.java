...
public class PeopleStateActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        String url = NetContants.H5_URL + "#/showPeopleStatus?device=h5&uid=" + MyApp.sharedPreferences.getInt("user_id",0);
        Log.e("url", url);
        webview.loadUrl(url);
