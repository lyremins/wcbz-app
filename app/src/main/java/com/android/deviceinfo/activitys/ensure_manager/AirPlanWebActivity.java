...
public class AirPlanWebActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        String url = NetContants.H5_URL + "#/showPlan?device=h5&uid=" + MyApp.sharedPreferences.getInt("user_id",0);
        Log.e("url", url);
        webview.loadUrl(url);
        ...
        webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                if (!url.contains("showPlan")){
                    tvTitle.setText("添加飞行计划");
                }
            }
        });
